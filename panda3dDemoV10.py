...
class MyApp(ShowBase):
    ...
    def drawHomeScreen(self):
        ...
        homeTitleObject = OnscreenText(parent=self.helpFrame, text = helpTitle, pos = (1,-.35,0),  #set parent??
        ...
        self.startButton = DirectButton(parent=self.helpFrame,pos=(1,0,-1.8), text=startText,
                                   scale=.1, pad=(.1, .1),
                                   command=self.closeHelpMenu)
