...
class MyApp(ShowBase):
    ...
    def modTerrain(self):
        ...
        d1 = x%3
        print(x,y,z, self.almostEqual(x%3,0))
        if self.almostEqual(d1, 0): #use almost equal
            print('hah')
        ...
        d2 = y%3
        if self.almostEqual(d2, 0): #almost equal 
            ...
            if self.up > self.down:
                ...
                print(planeIndices, posVals, newY)
